...
export function DropdownButton<T extends React.ElementType = typeof Button>({
  ...
  className,
  ...props
}: { className?: string; plain?: boolean } & Omit<
  ...
  return (
    <Headless.MenuButton
      ...
      className={clsx(
        className,
        plain &&
          "bg-transparent border-none shadow-none p-0 hover:bg-transparent data-[hover]:bg-transparent",
      )}
      {...(plain && as === Button ? { variant: "ghost" } : {})}
      {...props}
    />
  );
}
