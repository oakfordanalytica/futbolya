...
export interface MatchTimelineTeam {
  name: string;
  logoUrl?: string;
}
    ...
    <Tooltip open={active}>
      <TooltipTrigger asChild>
        <button
          type="button"
          className={cn(
            "absolute z-20 flex min-h-11 min-w-11 -translate-x-1/2 items-center rounded-full outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
...
export function MatchTimelineView({
  title,
  homeTeam,
  awayTeam,
  events,
