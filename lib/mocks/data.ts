...
export const matches = [
  {
    ...
    country: "Qatar",
    goalScorers1: [
      { name: "J Kim", minute: "26'" },
      { name: "H Jeong", minute: "48'" },
      { name: "Y Yi", minute: "87' Pen" },
    ],
    goalScorers2: [{ name: "A Toure", minute: "35'" }],
  },
  {
    id: 2,
    status: "FT",
    ...
    country: "Qatar",
    goalScorers1: [
      { name: "M Mijailovic", minute: "17'" },
      { name: "F Contreras", minute: "20' OG" },
      { name: "58'", minute: "" },
    ],
    goalScorers2: [{ name: "A De Nigris", minute: "57'" }],
  },
  {
    id: 3,
    status: "FT",
    ...
    country: "Qatar",
    goalScorers1: [
      { name: "M Solarte", minute: "25'" },
      { name: "S Londoño", minute: "33' Pen" },
    ],
    goalScorers2: [],
  },
  {
    ...
    score1: 0,
    score2: 7,
    venue: "Aspire Zone Pitch 5",
    city: "Ar-Rayyan",
    country: "Qatar",
    goalScorers1: [],
    goalScorers2: [
      { name: "J Mensah", minute: "32'" },
      { name: "57'", minute: "" },
      { name: "A Staff", minute: "41'" },
      { name: "W Mike", minute: "45'" },
      { name: "A Reyes", minute: "52' OG" },
      { name: "L Eickel", minute: "69'" },
      { name: "C Prenaj", minute: "84'" },
    ],
  },
];
