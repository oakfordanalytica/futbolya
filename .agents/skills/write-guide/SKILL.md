...
- For essays, reports, or analytical prose without code progression, use `russellian-clear-writing` instead.
- For architecture, workflow, sequence, or schema diagrams within the guide, use `mermaid-diagrams` to author them.
