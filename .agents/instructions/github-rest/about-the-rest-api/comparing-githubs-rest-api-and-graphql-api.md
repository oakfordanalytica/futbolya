...
You should use the API that best aligns with your needs and that you are most comfortable using. You don't need to exclusively use one API over the other. Node IDs let you move between the REST API and GraphQL API. For more information, see [Using global node IDs](/en/enterprise-cloud@latest/graphql/guides/using-global-node-ids).

This article discusses the benefits of each API. For more information about the GraphQL API, see [About the GraphQL API](/en/enterprise-cloud@latest/graphql/overview/about-the-graphql-api). For more information about the REST API, see [About the REST API](/en/enterprise-cloud@latest/rest/about-the-rest-api/about-the-rest-api).
