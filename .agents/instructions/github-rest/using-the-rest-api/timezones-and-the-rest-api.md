...
An example of this is the API to manage commits. For more information, see [REST API endpoints for Git commits](/en/enterprise-cloud@latest/rest/git/commits#create-a-commit).
