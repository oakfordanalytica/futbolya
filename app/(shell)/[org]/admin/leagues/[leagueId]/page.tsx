...
export default function LeagueDetailPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      router.push(`/${orgSlug}/admin/leagues`);
    } catch (error) {
      console.error(error);
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Button
              variant="ghost"
              size="icon"
              onClick={() => router.push(`/${orgSlug}/admin/leagues`)}
            >
          ...
          <CardContent>
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              ...
              <Button
                variant="outline"
                className="h-24 flex-col"
                onClick={() => router.push(`/${orgSlug}/admin/referees`)}
              >
              ...
              <Button
                variant="outline"
                className="h-24 flex-col"
                onClick={() => router.push(`/${orgSlug}/admin/tournaments`)}
              >
